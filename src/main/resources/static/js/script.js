...
function loading() {
  ...
  var drawing = setInterval(async () => {
    ...
    document.getElementById("sad").innerHTML =
      " " + resizedDetections[0].expressions.sad.toFixed(4);
    document.getElementById("neutral").innerHTML =
      " " + resizedDetections[0].expressions.neutral.toFixed(4);
    document.getElementById("angry").innerHTML =
      " " + resizedDetections[0].expressions.angry.toFixed(4);
    document.getElementById("surprised").innerHTML =
      " " + resizedDetections[0].expressions.surprised.toFixed(4);
    document.getElementById("happy").innerHTML =
      " " + resizedDetections[0].expressions.happy.toFixed(4);
    document.getElementById("disgusted").innerHTML =
      " " + resizedDetections[0].expressions.disgusted.toFixed(4);
    document.getElementById("fearful").innerHTML =
      " " + resizedDetections[0].expressions.fearful.toFixed(4);
  }, 100);
    ...
    var predicting = setInterval(async () => {
      ...
      if (left_second < 0) {
        ...
        $(document).ready(function () {
          // $.ajax({
          //   url: "http://localhost:8080/user/0", //유저 아이디 수정 필요
          //   data: "get",
